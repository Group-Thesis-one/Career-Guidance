...
class MainActivity : ComponentActivity() {
    ...
    fun App() {
        ...
        // Launcher to pick a PDF and upload to Supabase
        val uploadCvLauncher = rememberLauncherForActivityResult(
            ...
            if (uri != null) {
                ...
                // Read file into memory (CVs are small, so ok)
                ...
                // use service_role key in Authorization to bypass RLS (ok for this school project)
        ...
        Surface(
            ...
            NavHost(
                ...
                composable("signup") {
                    SignupScreen(
                        onSignupSuccess = { /* handled by listener */ },
                ...
                composable("home") {
                    HomeScreen(
                        ...
                        onUploadCvClick = {
                            uploadCvLauncher.launch(arrayOf("application/pdf"))
                        },
                        onLogout = {
